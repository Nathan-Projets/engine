...
namespace resources
{
    ...
    public:
        ...
        void SetData(std::vector<MeshVertex> vertices, std::vector<uint32_t> indices, std::vector<MeshPrimitive> primitives = {})
        {
            ...
            {
                m_primitives.push_back({0, static_cast<uint32_t>(m_indices.size()), 0, "default"});
            }
